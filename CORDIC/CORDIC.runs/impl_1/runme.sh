...
HD_PWD='C:/Users/DELL/Documents/studies/semestre 2/MSCL/CORDIC/CORDIC/CORDIC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processeur.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processeur.tcl -notrace
